      ...
      <main className="relative overflow-hidden">
          ...
          <div className="relative z-10 mx-auto flex min-h-[780px] w-full max-w-7xl flex-col items-center justify-center px-5 py-28 text-center sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="mx-auto mt-6 max-w-2xl text-pretty text-base leading-relaxed text-zinc-600 dark:text-zinc-400 sm:text-lg">
                ...
                drift, and managing OAuth tokens manually. @daraja/sdk provides
                strict end-to-end types, client-side pre-flight validation, and
                native edge compatibility with zero dependencies.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              className="mt-10 flex w-full max-w-[280px] sm:max-w-[320px] flex-col items-stretch gap-3 mx-auto"
            >
              <InstallCommand packageName="@daraja/sdk" />

              <Link
                href="/docs"
                className="group flex h-11 w-full items-center justify-between rounded-xl bg-zinc-900 px-4 text-xs sm:text-sm font-medium text-zinc-50 shadow-sm transition-all duration-200 hover:bg-zinc-800 hover:shadow-md dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-white"
              >
            ...
            <motion.div
              ...
              className="mt-12 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-xs text-zinc-500 dark:text-zinc-400 font-medium"
            >
          ...
          <div className="relative mx-auto w-full max-w-7xl px-5 py-24 sm:px-6 md:py-32 lg:px-8">
            ...
            >
              <div className="mb-4 inline-flex items-center gap-2.5">
                <span className="font-mono text-xs uppercase tracking-widest text-[#00A651] font-semibold">
              ...
              {architecturalSolutions.map((item, index) => {
                ...
                return (
                  <motion.article
                    ...
                    style={
                      {
                        "--card-glow": "rgba(0, 166, 81, 0.18)",
                      } as React.CSSProperties
                    }
                    className={`group category-card-hover relative flex min-h-[240px] flex-col justify-between overflow-hidden rounded-2xl border border-zinc-200/80 bg-white p-6 transition-all duration-300 hover:border-[#00A651]/40 dark:border-zinc-800/80 dark:bg-zinc-900/40 dark:hover:border-[#00A651]/50 sm:p-7 ${item.span}`}
                  >
                    <div>
                ...
                {Features.map((feature, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      group-hover:border-[#00A651]/30
                      group-hover:bg-[#00A651]/[0.06]
                      group-hover:shadow-[0_0_24px_-12px_#00A651]
                    "
                          >
                            <Icon
                              aria-hidden="true"
        ...
        <section className="relative overflow-hidden">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6, ease: easing }}
            className="mx-auto flex w-full max-w-4xl flex-col items-center px-5 py-28 text-center sm:px-6 md:py-36 lg:px-8"
          >
            <div className="mb-4 inline-flex items-center gap-2 px-3 py-1 rounded-full border border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900/50 text-xs font-mono text-zinc-600 dark:text-zinc-400">
              <span>Ready to deploy</span>
            </div>

            <h2 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl text-zinc-950 dark:text-zinc-50">
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-3.5 sm:flex-row w-full max-w-md">
              ...
              <Link
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex h-12 w-full sm:w-auto items-center justify-center gap-2.5 rounded-full border border-zinc-200/80 bg-white px-7 text-sm font-medium text-zinc-900 transition-all duration-200 hover:bg-zinc-50 hover:border-zinc-300 dark:border-zinc-800 dark:bg-zinc-900/80 dark:text-zinc-100 dark:hover:bg-zinc-800 dark:hover:border-zinc-700 shadow-sm"
              >
            ...
            <div className="mt-12 flex items-center gap-3 rounded-full border border-zinc-200/80 bg-zinc-50/80 px-4 py-2 font-mono text-xs text-zinc-600 shadow-sm dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-400 backdrop-blur-md">
              <NPM className="size-4 text-red-500 shrink-0" />
              <span>npm install @daraja/sdk</span>
              <CopyButton
                text="npm install @daraja/sdk"
                className="shrink-0 ml-1.5 hover:text-zinc-950 dark:hover:text-white transition-colors"
              />
            </div>
          </motion.div>
        </section>
